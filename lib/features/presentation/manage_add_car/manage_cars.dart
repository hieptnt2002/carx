...
import 'package:carx/features/presentation/manage_add_car/manage_add_car.dart';
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const ManageAddCar(),
                    settings: RouteSettings(arguments: distributor.id)));
          },
